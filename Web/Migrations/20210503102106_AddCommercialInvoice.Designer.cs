...
namespace Web.Migrations
{
    ...
    [Migration("20210503102106_AddCommercialInvoice")]
    partial class AddCommercialInvoice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("newkilibraries.CommercialInvoice", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CommercialInvoiceDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset>("CommercialInvoiceDueDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("CommercialInvoice");
                });

            modelBuilder.Entity("newkilibraries.CommercialInvoiceDataView", b =>
                {
                    b.Property<int>("CommercialInvoiceId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CommercialInvoiceDataView");
                });

            modelBuilder.Entity("newkilibraries.CommercialInvoiceDocumentFile", b =>
                {
                    b.Property<int>("CommercialInvoiceId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("CommercialInvoiceId", "DocumentFileId");

                    b.HasIndex("DocumentFileId");

                    b.ToTable("CommercialInvoiceDocumentFile");
                });

            modelBuilder.Entity("newkilibraries.CommercialInvoiceExtra", b =>
                {
                    b.Property<int>("CommercialInvoiceExtraId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("CommercialInvoiceExtraId");

                    b.HasIndex("CommercialInvoiceId");

                    b.ToTable("CommercialInvoiceExtra");
                });
            ...
            modelBuilder.Entity("newkilibraries.CommercialInvoiceDocumentFile", b =>
                {
                    b.HasOne("newkilibraries.CommercialInvoice", "CommercialInvoice")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("newkilibraries.CommercialInvoiceExtra", b =>
                {
                    b.HasOne("newkilibraries.CommercialInvoice", null)
                        .WithMany("Extras")
                        .HasForeignKey("CommercialInvoiceId");
                });
